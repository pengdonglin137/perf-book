% CJK font support for Chinese translation
\usepackage{xeCJK}
...
% Ensure \BackrefFootnoteTag is defined (compatibility fix)
...
% Remove image transparency for color printing (pdfTeX only)
